...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		EmployeeDatabaseUtil dbutil = new EmployeeDatabaseUtil();
		...
		do {
			employeeList = dbutil.getAllEmployees();
			...
			case 1:
				...
				result = dbutil.addNewEmployee(employee);
				if (result) {
			...
			case 2:
				...
				result = dbutil.addAllEmployees(employees);
				if (result) {
			...
			case 3:
				...
				employeeId = scanner.nextInt();
				scanner.nextLine();
				employee = dbutil.getEmployeeByEmployeeId(employeeId);
				if (employee != null) {
					System.out.println("Enter New Salary:");
					salary = scanner.nextDouble();
					//System.out.println("Input Accepted");
					result = dbutil.updateEmployeeSalary(employeeId, salary);
					if (result) {
			...
			case 4:
				...
				employee = dbutil.getEmployeeByEmployeeId(employeeId);
				if (employee != null) {
					result = dbutil.deleteEmployee(employeeId);
					if (result) {
