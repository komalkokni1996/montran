...
public class BookIssueMasterForm extends ActionForm{
	...
	private String dueDateOfReturn;
	...
	public BookIssueMasterForm(int issueSerialNumber, String memberCode, String name, String bookCode, String bookTitle,
			String bookAuthor, String dateOfIssue, String dueDateOfReturn, BookMaster book, MemberMaster member) {
		super();
	...
	public String getDueDateOfReturn() {
		System.out.println("In BookIssueMasterForm's getDueDateOfReturn()");
		return dueDateOfReturn;
	}

	public void setDueDateOfReturn(String dueDateOfReturn) {
		System.out.println("In BookIssueMasterForm's setDueDateOfReturn()");
		this.dueDateOfReturn = dueDateOfReturn;
	}
	...
	public String toString() {
		return "BookIssueMasterForm [issueSerialNumber=" + issueSerialNumber + ", memberCode=" + memberCode + ", name="
				+ name + ", bookCode=" + bookCode + ", bookTitle=" + bookTitle + ", bookAuthor=" + bookAuthor
				+ ", dateOfIssue=" + dateOfIssue + ", dueDateOfReturn=" + dueDateOfReturn + ", book=" + book
				+ ", member=" + member + "]";
	}
